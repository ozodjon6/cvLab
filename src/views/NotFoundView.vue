<template>
  <div class="min-h-screen bg-gray-50 dark:bg-navy-900 flex flex-col transition-colors duration-300">
    ...
    <main class="flex-1 flex flex-col items-center justify-center px-4 py-24 text-center">
      <div class="h-24 w-24 bg-blue-50 dark:bg-blue-900/40 text-blue-brand dark:text-blue-400 rounded-full flex items-center justify-center mb-6">
      ...
      <p class="text-gray-500 dark:text-gray-400 max-w-sm mx-auto mb-8">
        Siz qidirayotgan sahifa mavjud emas yoki tizimga kirmaganingiz uchun yashirilgan bo'lishi mumkin.
      </p>
