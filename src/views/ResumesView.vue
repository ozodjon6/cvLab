    ...
    <main class="flex-1 pt-24 px-4 sm:px-8 max-w-5xl mx-auto w-full">
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div v-for="item in resumes" :key="item.id" 
          ...
          <div class="px-6 py-3 bg-gray-50 dark:bg-navy-900 border-t border-gray-100 dark:border-gray-700 text-sm font-medium text-blue-brand dark:text-blue-400 flex items-center justify-between group-hover:bg-blue-50 dark:group-hover:bg-blue-900/40 transition-colors">
            Tahrirlash
